...
class TRUCKDataset(CustomDataset):
    """TRUCK dataset for detection.
    ...
    def __init__(self,
        ...
        super(TRUCKDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        """
            Args:
                ann_folder: folder that contains DOTA v1 style annotations txt files
        """
        cls_map = {c: i
